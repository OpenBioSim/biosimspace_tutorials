...
Users wishing to deploy RBFE pipelines via the OpenBioSim Snakemake workflow will need to use the pipelines available at:
\begin{itemize}
    \item \url{https://github.com/OpenBioSim/rbfe_workflow}
\end{itemize}
...
%%%%%%%%%%%%%%%%
LH prepared Tutorial 1, DL and LH prepared Tutorial 2, AH and LH prepared Tutorial 3, JS, AK, LH, AH, FC, MB and JM prepared Tutorial 4, which was built on older tutorial material by AM and SB and on contributions from ZW, MS, and BC. MB and CW reviewed and tested all tutorials and ported the tutorials to a web server. The authors are listed in alphabetical order, with the exception of the first coauthor.
