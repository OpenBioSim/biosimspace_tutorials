...
\newcommand{\githubrepository}{\url{https://github.com/OpenBioSim/BioSimSpaceTutorials}}  %this should be the main github repository for this article
...
\orcid{Anna M. Herz}{EEEE-FFFF-GGGG-HHHH}
...
\orcid{Miroslav Suruzhon}{EEEE-FFFF-GGGG-HHHH}
\orcid{Christopher J Woods}{EEEE-FFFF-GGGG-HHHH}
